...
HPARAM_SCHEDULE = [
    ...
    # --- Phase 3: exploit c13 insights (short seq + directional) ---
    {"name": "c16_seq10_dir", "d_model": 96, "d_state": 48, "n_layers": 2, "expand": 2, "headdim": 16,
     "dropout": 0.02, "lr": 1e-4, "weight_decay": 1e-6, "epochs": 150, "batch_size": 64, "loss_alpha": 1.0,
     "q": 0.3, "patience": 30, "seq_len": 10},
    {"name": "c17_seq15_dir", "d_model": 96, "d_state": 48, "n_layers": 2, "expand": 2, "headdim": 16,
     "dropout": 0.02, "lr": 1e-4, "weight_decay": 1e-6, "epochs": 150, "batch_size": 64, "loss_alpha": 1.0,
     "q": 0.3, "patience": 30, "seq_len": 15},
    {"name": "c18_seq5_dir", "d_model": 64, "d_state": 32, "n_layers": 2, "expand": 2, "headdim": 16,
     "dropout": 0.01, "lr": 2e-4, "weight_decay": 1e-6, "epochs": 150, "batch_size": 128, "loss_alpha": 1.0,
     "q": 0.3, "patience": 30, "seq_len": 5},
    {"name": "c19_seq20_q40", "d_model": 96, "d_state": 48, "n_layers": 2, "expand": 2, "headdim": 16,
     "dropout": 0.02, "lr": 1e-4, "weight_decay": 1e-6, "epochs": 150, "batch_size": 64, "loss_alpha": 1.0,
     "q": 0.4, "patience": 30, "seq_len": 20},
    {"name": "c20_seq20_wider", "d_model": 128, "d_state": 64, "n_layers": 2, "expand": 2, "headdim": 32,
     "dropout": 0.02, "lr": 5e-5, "weight_decay": 1e-6, "epochs": 150, "batch_size": 64, "loss_alpha": 1.0,
     "q": 0.3, "patience": 30, "seq_len": 20},
    {"name": "c21_seq20_deep", "d_model": 96, "d_state": 48, "n_layers": 3, "expand": 2, "headdim": 16,
     "dropout": 0.02, "lr": 5e-5, "weight_decay": 1e-6, "epochs": 150, "batch_size": 64, "loss_alpha": 1.0,
     "q": 0.3, "patience": 30, "seq_len": 20},
    {"name": "c22_seq20_lr3e5", "d_model": 96, "d_state": 48, "n_layers": 2, "expand": 2, "headdim": 16,
     "dropout": 0.02, "lr": 3e-5, "weight_decay": 1e-6, "epochs": 200, "batch_size": 64, "loss_alpha": 1.0,
     "q": 0.3, "patience": 40, "seq_len": 20},
    {"name": "c23_seq20_q20", "d_model": 96, "d_state": 48, "n_layers": 2, "expand": 2, "headdim": 16,
     "dropout": 0.02, "lr": 1e-4, "weight_decay": 1e-6, "epochs": 150, "batch_size": 64, "loss_alpha": 1.0,
     "q": 0.2, "patience": 30, "seq_len": 20},
]
